...
/**
 * Script de Testing: Flujo Completo 2027
 * Desde Nivel Académico hasta Matrícula con Pagos
 * 
 * Incluye:
 * - Conceptos: Matrícula (obligatorio, único) + Pensión (obligatorio, mensual) + 3 opcionales
 * - Tarifas por Grado
 * - Descuentos/Becas
 * - Matrícula con generación de pagos
 */
...
class Testing2027
{
    ...
    {
        echo "\n╔════════════════════════════════════════════════════════════════╗\n";
        echo "║  TESTING 2027: FLUJO COMPLETO CON TARIFAS Y DESCUENTOS        ║\n";
        echo "╚════════════════════════════════════════════════════════════════╝\n\n";
        ...
        try {
            ...
            // FASE 3: Crear Nivel Académico
            echo "\nFASE 3: Creando Nivel Académico...\n";
            $nivel = $this->crearNivel();

            // FASE 4: Crear Grado
            echo "\nFASE 4: Creando Grado...\n";
            $grado = $this->crearGrado($nivel);

            // FASE 5: Crear Tarifas por Grado
            echo "\nFASE 5: Creando Tarifas de Pago por Grado...\n";
            $this->crearTarifas($conceptos, $nivel, $grado);

            // FASE 6: Crear Descuentos/Becas
            echo "\nFASE 6: Creando Descuentos/Becas...\n";
            $this->crearDescuentos($conceptos);

            // FASE 7: Crear Sección
            echo "\nFASE 7: Creando Sección...\n";
            $seccion = $this->crearSeccion($grado);

            // FASE 8: Crear Alumno
            echo "\nFASE 8: Creando Alumno...\n";
            $alumno = $this->crearAlumno();

            // FASE 9: Crear Padre/Apoderado
            echo "\nFASE 9: Creando Padre/Apoderado...\n";
            $padre = $this->crearPadre();

            // FASE 10: Vincular Padre con Alumno
            echo "\nFASE 10: Vinculando Padre con Alumno...\n";
            $this->vincularPadreConAlumno($alumno, $padre);

            // FASE 11: Crear Apertura de Matrícula
            echo "\nFASE 11: Creando Apertura de Matrícula...\n";
            $apertura = $this->crearAperturaMatricula();

            // FASE 12: Matricular Alumno
            echo "\nFASE 12: Matriculando Alumno...\n";
            $matricula = $this->matricularAlumno($alumno, $seccion, $apertura);

            // FASE 13: Generar Pagos de Matrícula
            echo "\nFASE 13: Generando Pagos de Matrícula...\n";
            $this->generarPagosMatricula($alumno, $padre, $conceptos);

            // FASE 14: Verificar Pagos
            echo "\nFASE 14: Verificando Pagos Creados...\n";
            $this->verificarPagos($alumno);

            echo "\n╔════════════════════════════════════════════════════════════════╗\n";
            echo "║  ✅ TESTING 2027 COMPLETADO EXITOSAMENTE                      ║\n";
            echo "║                                                                ║\n";
            ...
            echo "║  ✅ Grado creado                                               ║\n";
            echo "║  ✅ Tarifas de Pago por Grado creadas                          ║\n";
            echo "║  ✅ Descuentos/Becas creados                                   ║\n";
            echo "║  ✅ Sección creada                                             ║\n";
            echo "║  ✅ Alumno creado                                              ║\n";
            ...
            echo "║                                                                ║\n";
            echo "║  El sistema de pagos 2027 está COMPLETAMENTE FUNCIONAL         ║\n";
    ...
    private function crearGrado($nivel)
    {
        ...
        echo "  ✅ Grado creado (ID: {$grado['grado_id']}, {$grado['nombre_grado']})\n";
        return $grado;
    }

    private function crearTarifas($conceptos, $nivel, $grado)
    {
        $tarifas = [
    ...
    private function crearDescuentos($conceptos)
    {
        $descuentos = [
            ['nombre' => 'Beca General 15%', 'tipo' => 'porcentaje', 'valor' => 15, 'concepto_id' => null],
